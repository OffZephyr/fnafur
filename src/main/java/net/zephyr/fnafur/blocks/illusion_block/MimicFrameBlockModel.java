                        ...
                        for (Direction direction : Direction.values()) {
                            ...
                            if (sideBlock == null) {
                                ...
                                if (part == 1) {
                                    ...
                                    switch (direction) {
                                        case NORTH, SOUTH: {
                                            float x0 = direction == Direction.SOUTH ? 0 + (x * part) : (1 - part) - (x * part);
                                            float x1 = direction == Direction.SOUTH ? part + (x * part) : 1 - (x * part);
                                            float depth = direction == Direction.SOUTH ? (1 - part) - (z * part) : 0 + (z * part);
                                            emitter.square(direction, x0, 0 + (y * part), x1, part + (y * part), depth);
                                            break;
                                        }
                                        case WEST, EAST: {
                                            float x0 = direction == Direction.WEST ? 0 + (z * part) : (1 - part) - (z * part);
                                            float x1 = direction == Direction.WEST ? part + (z * part) : 1 - (z * part);
                                            float depth = direction == Direction.EAST ? (1 - part) - (x * part) : 0 + (x * part);
                                            emitter.square(direction, x0, 0 + (y * part), x1, part + (y * part), depth);
                                            break;
                                        }
                                        case UP, DOWN: {
                                            float z0 = direction == Direction.DOWN ? 0 + (z * part) : (1 - part) - (z * part);
                                            float z1 = direction == Direction.DOWN ? part + (z * part) : 1 - (z * part);
                                            float depth = direction == Direction.UP ? (1 - part) - (y * part) : 0 + (y * part);
                                ...
                                int color = getColor(direction, index);
