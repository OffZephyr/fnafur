...
public class WallPizza extends WallPropBlock<WallPizzaSkins> {
    public WallPizza(Properties settings) {
        super(settings);
    }
    ...
    @Override
    public Class<WallPizzaSkins> COLOR_ENUM() {
        return WallPizzaSkins.class;
    }
