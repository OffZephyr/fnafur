package net.zephyr.fnafur.blocks.props.wall_props.wall_menu;
...
public class WallMenu extends WallPropBlock<DefaultPropColorEnum> {
    public WallMenu(Properties settings) {
        super(settings);
    }
    ...
    protected VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
        VoxelShape shape = switch (state.getValue(FACING)){
            default -> Shapes.box(-0.18f, 0f, 0, 1.175f, 1.75f, 0.1f);
        };
