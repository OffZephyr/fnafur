...
public class Locker extends FloorPropBlock<LockerColors> implements GeoPropBlock {
    private Identifier texture;
    private Identifier model;
    private Identifier animations;
    public Locker(Settings settings) {
        super(settings);
    }
    ...
    protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        shape = VoxelShapes.union(shape, VoxelShapes.cuboid(new Box(0f, 0, 0f, 1f, 1.5f, 1f)));
        return drawingOutline ? shape : VoxelShapes.fullCube();
    }

    @Override
    public Class <LockerColors> COLOR_ENUM() {
        return LockerColors.class;
    }
