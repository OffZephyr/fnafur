...
public class RetroStool extends FloorPropBlock<RetroStoolColors> implements SeatBlock {
    public RetroStool(Properties settings) {
        super(settings);
    }

    @Override
    public Class<RetroStoolColors> COLOR_ENUM() {
        return RetroStoolColors.class;
    }
