...
public class AnimatronicBlockColoredEyeLayer<T extends AnimatronicBlockEntity> extends GeoRenderLayer<T> {
    public AnimatronicBlockColoredEyeLayer(GeoRenderer<T> entityRendererIn) {
