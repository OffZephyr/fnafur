...
public class AnimatronicBetaRenderer<T extends AnimatronicEntity> extends GeoEntityRenderer<T> {
    ...
    int popAmount = 0;
    int subPopAmount = 0;
    public AnimatronicBetaRenderer(EntityRendererFactory.Context renderManager) {
        super(renderManager, new AnimatronicBetaModel<>());
    }
    ...
    public GeoBone renderPart(PartType part, String modelBoneName, GeoBone previousBone, MatrixStack poseStack, T animatable, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, boolean isSubPart, boolean isAccessory, boolean isLimb, float partialTick, int packedLight,
        ...
        String prevModelName = part.PREVIOUS == null ? AnimatronicBetaModel.DEFAULT_CHARACTER : ModelMap.get(part.PREVIOUS);
    ...
    public GeoBone getModelBone(String boneName, CharacterModelManager.Chara character, String variant) {
        ((AnimatronicBetaModel<T>)this.model).currentModel = CharacterModelManager.getVariantModel(character, variant);
    ...
    public GeoModel<T> getGeoModel() {
        ((AnimatronicBetaModel<T>)this.model).currentModel = this.currentModel;
