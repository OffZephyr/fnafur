...
public class AnimatronicBlockColoredLayer<T extends AnimatronicBlockEntity> extends GeoRenderLayer<T> {
    public AnimatronicBlockColoredLayer(GeoRenderer<T> entityRendererIn) {
