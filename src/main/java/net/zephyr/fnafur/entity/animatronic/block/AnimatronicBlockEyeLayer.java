...
public class AnimatronicBlockEyeLayer<T extends AnimatronicBlockEntity, O, R extends GeoRenderState> extends GeoRenderLayer<T, O, R> {

    public AnimatronicBlockEyeLayer(GeoRenderer<T, O, R> renderer) {
        super(renderer);
    }
