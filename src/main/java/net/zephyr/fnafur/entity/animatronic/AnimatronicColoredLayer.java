...
public class AnimatronicColoredLayer<T extends AnimatronicEntity> extends GeoRenderLayer<T> {
    public AnimatronicColoredLayer(GeoRenderer<T> entityRendererIn) {
