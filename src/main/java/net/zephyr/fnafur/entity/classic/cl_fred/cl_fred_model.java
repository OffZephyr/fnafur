...
public class cl_fred_model extends DefaultEntityModel<cl_fred> {

    @Override
    public void setCustomAnimations(cl_fred animatable, long instanceId, AnimationState<cl_fred> animationState) {
