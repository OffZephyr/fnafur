...
public class cl_foxy_model extends DefaultEntityModel<cl_foxy> {

    @Override
    public void setCustomAnimations(cl_foxy animatable, long instanceId, AnimationState<cl_foxy> animationState) {
