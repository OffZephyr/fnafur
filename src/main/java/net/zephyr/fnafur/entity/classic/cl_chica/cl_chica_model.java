...
public class cl_chica_model extends DefaultEntityModel<cl_chica> {

    @Override
    public void setCustomAnimations(cl_chica animatable, long instanceId, AnimationState<cl_chica> animationState) {
