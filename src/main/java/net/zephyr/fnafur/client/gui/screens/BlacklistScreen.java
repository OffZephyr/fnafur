...
public class BlacklistScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(RenderLayer::getGuiTextured, BACKGROUND, 0, 0, bgScroll/3f, 0, this.width, this.height, this.width, this.height);
        context.drawTexture(RenderLayer::getGuiTextured, TEXT_SCROLL, 0, this.height/36, -textScroll/2f, this.height/12, 1710, this.height/12, this.width, this.height/12);
        context.drawTexture(RenderLayer::getGuiTextured, ZEPHYR, 0, 0, 0, 0, this.width, this.height, this.width, this.height);

        context.fill(this.width/2, (this.height/3) * 2, this.width, (this.height/3) * 2 + (this.height/12), clickcolor);

        context.drawTexture(RenderLayer::getGuiTextured, TEXT1, 0, 0, 0, 0, this.width, this.height, this.width, this.height);
        context.drawTexture(RenderLayer::getGuiTextured, TEXT2, 0, 0, 0, 0, this.width, this.height, this.width, this.height);
