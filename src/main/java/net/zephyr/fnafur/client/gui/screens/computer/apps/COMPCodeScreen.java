...
public class COMPCodeScreen extends COMPBaseAppScreen {
    ...
    int maxSubScroll = 0;
    Identifier BASE = Identifier.of(FnafUniverseResuited.MOD_ID, "textures/gui/computer/code_window.png");
    Identifier LIST = Identifier.of(FnafUniverseResuited.MOD_ID, "textures/gui/computer/computer_list.png");
    Identifier BUTTONS = Identifier.of(FnafUniverseResuited.MOD_ID, "textures/gui/computer/computer_buttons.png");
