...
public class BlockPayloads {
    ...
    public static final Identifier C2SAddDecal = Identifier.of(FnafUniverseRebuilt.MOD_ID, "c2s_add_decal");
    public static final Identifier S2CAddDecal = Identifier.of(FnafUniverseRebuilt.MOD_ID, "s2c_add_decal");
    public static final Identifier C2SRemoveDecal = Identifier.of(FnafUniverseRebuilt.MOD_ID, "c2s_remove_decal");
    public static final Identifier S2CRemoveDecal = Identifier.of(FnafUniverseRebuilt.MOD_ID, "s2c_remove_decal");
    public static final Identifier C2SFetchDecals = Identifier.of(FnafUniverseRebuilt.MOD_ID, "c2s_fetch_decals");
    public static final Identifier S2CFetchDecals = Identifier.of(FnafUniverseRebuilt.MOD_ID, "s2c_fetch_decals");
