...
public class EntityPayloads {
    ...
    public static final Identifier C2SWorkbenchSave = Identifier.of(FnafUniverseResuited.MOD_ID, "c2s_workbench_save");
    public static final Identifier S2CWorkbenchSave = Identifier.of(FnafUniverseResuited.MOD_ID, "s2c_workbench_save");
